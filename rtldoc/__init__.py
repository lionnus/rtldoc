...
The command line is `rtldoc`. This package is also a library:

    from rtldoc import build_documentation
...
def __getattr__(name: str):
    """Imports on demand. Thus `rtldoc --version` does not load pyslang."""
